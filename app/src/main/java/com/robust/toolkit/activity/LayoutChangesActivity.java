...
import com.robust.toolkit.MainActivity;
...
public class LayoutChangesActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_changes_activity_content_layout);
        ...
        Animator disappearingAnimation = ObjectAnimator.ofFloat(null, "translationX", 0, 600);
        appearingAnimation.setDuration(45);
        layoutTransition.setAnimator(LayoutTransition.APPEARING, appearingAnimation);
        layoutTransition.setAnimator(LayoutTransition.DISAPPEARING, disappearingAnimation);
        mContainerView.setLayoutTransition(layoutTransition);
    }
